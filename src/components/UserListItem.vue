...
export default {
  ...
  methods: {
    ...
    loadUser() {
      if (this.user) {
        this.newFriendship = this.friendships.find((friendship) =>
      ...
      console.log('friendship', this.newFriendship);
      // console.log('avatar user', this.avatarUser);
  ...
  <li v-if="isLoaded" class="list-group-item d-flex align-items-center friend-list-item">
    ...
    <div class="dropdown ms-auto">
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        ...
        <li v-if="newFriendship?.isWaitingOnFriend(authUser) && avatarUser?.id !== authUser?.id">
          <button class="dropdown-item text-danger" @click="deleteFriendship(newFriendship)">Cancel Request</button>
        </li>
        <li v-if="newFriendship?.isWaitingOnUser(authUser) && avatarUser?.id !== authUser?.id">
        ...
        <li v-if="newFriendship?.isApproved() && avatarUser?.id !== authUser?.id">
